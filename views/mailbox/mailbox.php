                ...
                <div class="grid-body">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <a class="btn btn-block btn-primary" data-toggle="modal" data-target="#compose-modal"><i class="fa fa-pencil"></i>&nbsp;&nbsp;Nouveau message</a>

                            <hr>

                            <div>
                                <ul class="nav nav-pills nav-stacked">
                                    <li class="header">Dossiers</li>
                                    <li class="active"><a href="#"><i class="fa fa-inbox"></i> Boîte de réception (127)</a></li>
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    <tbody>
                                        ...
                                        <tr class="read">
                                            <td class="action">
                                                <div class="icheckbox_square-blue" st<td class="action"><input type="checkbox"></div>
                                            </td>
