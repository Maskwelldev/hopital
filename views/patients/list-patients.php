...
<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
    ...
    <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
        <div class="input-group">
            <input type="text" class="form-control bg-light border-0 small" placeholder="Chercher un patient..."
...
<?php } else { ?>
    <h1 class="text-primary mb-5">Liste des patients</h1>
    ...
    <table class="table table-striped">
        ...
        foreach($patients as $patient) {
            ...
            <tr>
                ...
                <td>
                    <a href="/controllers/edit-patientCtrl.php?id=<?=htmlentities($patient->id)?>"><i
                            class="far fa-edit"></i></a>
                    <a href="/controllers/delete-patientCtrl.php?id=<?=$patient->id?>"><i class="fas fa-trash fs-5"></i></a>
                </td>
            </tr>
            <?php } ?>
